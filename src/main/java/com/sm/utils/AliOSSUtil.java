...
public class AliOSSUtil {
    ...
    public static String ossUpload(File file) {
        ...
        String bucketDomain = "https://rapids.oss-cn-beijing.aliyuncs.com/";
        //Endpoint以北京为例，其它Region请按实际情况填写
        String endpoint = "http://oss-cn-beijing.aliyuncs.com";
        //accessKeyId和accessKeySecret，请填写自己的
        String accessKeyId = "LTAIDOhWdZRQH2kX";
        String accessKeySecret = "tGj2daM8C5BLpOr2fbtqDnCtzkWomW";
        //Bucket名称
        String bucketName = "rapids";
        //目录名称
        String filedir = "logo/";
        //获得本地文件的文件名
